...
using CoinCollection.Extensions;

namespace CoinCollection.Comparers
{
	public class CollectionItemSetComparer : Comparer<HashSet<CollectionItem>>
    {
        public override int Compare(HashSet<CollectionItem>? set1, HashSet<CollectionItem>? set2)
        {
